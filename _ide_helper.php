...
namespace {
    ...
    class eAdminSlider extends \idealcoms\eadmin\Facades\EadminSlider{
         ...
         * @static 
         */
        public static function slider($name = null, $template = 'bootstrap', $options = null){
            return \idealcoms\eadmin\Classes\EAdminSlider::slider($name, $template, $options);
        }
        
    }


    class NEWS extends \idealcoms\eadmin\Facades\NEWS{
         ...
         */
        public static function all(){
            return \idealcoms\eadmin\Classes\FormNews::all();
        }
         ...
         */
        public static function current(){
            return \idealcoms\eadmin\Classes\FormNews::current();
        }
        ...
        public static function first(){
            return \idealcoms\eadmin\Classes\FormNews::first();
        }
        
        /**
         * Create picture link template
         *
         * @param \idealcoms\eadmin\Classes\NewsRepository $new
         * @param Array $class
         * @return string 
         * @static 
         */
        public static function image($new, $class = null){
            return \idealcoms\eadmin\Classes\FormNews::image($new, $class);
        }
        
        /**
         * Create learn more link template
         *
         * @param \idealcoms\eadmin\Classes\NewsRepository $new
         * @param String $content
         * @param Array $class
         ...
         * @static 
         */
        public static function link($new, $content = null, $class = null, $type = null, $name = null, $title = null){
            return \idealcoms\eadmin\Classes\FormNews::link($new, $content, $class, $type, $name, $title);
        }
        
        /**
         * Create pdf download link template
         *
         * @param \idealcoms\eadmin\Classes\NewsRepository $new
         * @param String $content
         * @param Array $class
         ...
         * @static 
         */
        public static function pdf($new, $content = null, $class = null, $type = null, $name = null, $title = null){
            return \idealcoms\eadmin\Classes\FormNews::pdf($new, $content, $class, $type, $name, $title);
        }
        
        /**
         * Get news list where flaghome = true
         *
         * @static 
         */
        public static function top(){
            return \idealcoms\eadmin\Classes\FormNews::top();
        }
         ...
         * @static 
         */
        public static function startAt($new, $format = '%B %Y'){
            return \idealcoms\eadmin\Classes\FormNews::startAt($new, $format);
        }
         ...
         * @static 
         */
        public static function endAt($new, $format = '%B %Y'){
            return \idealcoms\eadmin\Classes\FormNews::endAt($new, $format);
        }
        
        /**
         * Create new top image template
         *
         * @param \idealcoms\eadmin\Classes\NewsRepository $new
         * @param Array $class
         * @param string $url
         ...
         * @static 
         */
        public static function topImage($new, $class = null, $url = null, $height = null){
            return \idealcoms\eadmin\Classes\FormNews::topImage($new, $class, $url, $height);
        }
        
        /**
         * Create new top title template
         *
         * @param \idealcoms\eadmin\Classes\NewsRepository $new
         * @param \Illuminate\Routing\Route $route
         * @param Array $class
         ...
         * @static 
         */
        public static function topTitle($new, $route = null, $class = null){
            return \idealcoms\eadmin\Classes\FormNews::topTitle($new, $route, $class);
        }
        
        /**
         * Create new top content template
         *
         * @param \idealcoms\eadmin\Classes\NewsRepository $new
         * @param int $truncate
         * @param \Illuminate\Routing\Route $route
         ...
         * @static 
         */
        public static function topContent($new, $truncate = null, $route = null, $class = null){
            return \idealcoms\eadmin\Classes\FormNews::topContent($new, $truncate, $route, $class);
        }
        
        /**
         * Create dynamic pagination list template
         *
         * @param Array $class
         * @return string 
         * @static 
         */
        public static function paginate($class = null){
            return \idealcoms\eadmin\Classes\FormNews::paginate($class);
        }
