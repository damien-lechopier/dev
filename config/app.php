...
//        App\Providers\PublicPathServiceProvider::class,
    	...
    	// Eadmin providers utilities
    	Rutorika\Sortable\SortableServiceProvider::class,
    		
        /**
         * eAdmin providers
         */
        idealcoms\eadmin\Providers\EadminServiceProvider::class,
        idealcoms\eadmin\Providers\NEWSServiceProvider::class,
        idealcoms\eadmin\Providers\EadminCatalogServiceProvider::class,
    ],
